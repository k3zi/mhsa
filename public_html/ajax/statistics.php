...
require_once('/home/mhsa/includes/include.php');
 ...
 echo json_encode(array('registered_users' => getTotalNumberOfPlayers(), 'alive_players' => getNumberOfPlayersAlive(), 'dead_players' => getNumberOfPlayersDead(), 'suicides' => getNumberOfPlayersSuicide(), 'assassinations' => getNumberOfKills()));
